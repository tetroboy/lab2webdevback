...
SECRET_KEY = "django-insecure-yz+d^-(zdhl=!mr51z17+&^rdla*!phu8(liuj7v*e)p_ky7w-"
...
ASGI_APPLICATION = "myenglish.asgi.application"
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8000",    # React (FrontEnd Url) # <-------- this
]
